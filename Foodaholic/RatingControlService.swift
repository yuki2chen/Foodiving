...
class RatingControlService: UIView {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        let filledRatePicture = UIImage(named: "winkface")
        ...
        for _ in 0..<5{
            ...
            button.addTarget(self, action: #selector(RatingControlService.ratingButtonTapped(_:)), forControlEvents: .TouchDown)
